...
sur cette quantité. Toutefois, nous n'avons pas encore d'information à propos de la quantité d'eau nécessaire.
...
température $T$ [$\kelvin$], nous avons l'expression suivante pour $K_1 (T)$ et $K_2 (T)$, respectivement les
constantes d'équilibre de la première et de la deuxième équation, avec $p_{tot}$ la pression totale dans le système et $p\degree$ la
pression standard de \unit{1}{\bbar}:
\[
\left \{
\begin{array}
