...
d'un catalyseur, \textsc{Haber} a réussi à faire en sorte que la réaction se déroule plus facilement. Il a également eu l'idée 
...
Les résultats obtenus grâce à notre outil de calcul \textsc{Matlab} concordent avec nos prédictions: une augmentation
...
\paragraph{Recyclage} Nous sommes en mesure de choisir une température et une pression favorisant la réaction. De par 
